...
import pandas_ta_classic as ta  # بديل pandas_ta بعد توقفها عن PyPI (أغسطس 2026)
...
def detect_liquidity_status(df, price, volume, volume_ratio):
    ...
    1) التجميع الصامت (silent_accumulation):
       ...
       خط التجميع والتصريف (A/D عبر pandas_ta_classic) في اتجاه صاعد،
